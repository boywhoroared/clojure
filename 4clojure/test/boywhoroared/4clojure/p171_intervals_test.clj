(ns
  ^{:id 171 :difficulty "medium" :tags [] :description "Write a function that takes a sequence of integers
...
(deftest problem-171-test
     (testing "Problem 171: Write a function that takes a sequence of integers
and returns a sequence of “intervals”.
Each interval is a a vector of two integers, start and end,
such that all integers between start and end (inclusive)
