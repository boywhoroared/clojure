(ns
  ^{:id 128 :difficulty "easy" :tags ["strings" "game"] :description "A standard American deck of playing cards has four suits - spades,
...
(deftest problem-128-test
     (testing "Problem 128: A standard American deck of playing cards has four suits - spades,
hearts, diamonds, and clubs - and thirteen cards in each suit. Two is the lowest rank,
followed by other integers up to ten; then the jack, queen, king, and ace.
