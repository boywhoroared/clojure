(ns
  ^{:id 195 :difficulty "medium" :tags ["math" "combinatorics"] :description "In a family of languages like Lisp, having balanced parentheses
...
(deftest problem-195-test
     (testing "Problem 195: In a family of languages like Lisp, having balanced parentheses
is a defining feature of the language. Luckily, Lisp has almost no syntax, except
for these "delimiters" -- and that hardly qualifies as "syntax", at least in any
useful computer programming sense.
...
(is (= (nth (sort (filter #(clojure.string/includes? % "(()()()())") (__ 9))) 6) "(((()()()())(())))"))
