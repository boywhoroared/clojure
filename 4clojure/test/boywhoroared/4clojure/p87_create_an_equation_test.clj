(ns
  ^{:id 87 :difficulty "" :tags nil :description "Write a function which takes three or more integers.
...
(deftest problem-87-test
     (testing "Problem 87: Write a function which takes three or more integers.
Using these integers, your function should
generate clojure code representing an equation.
The following rules for the equation must be satisfied:
