(ns
  ^{:id 137 :difficulty "medium" :tags ["math"] :description "Write a function which returns a sequence of digits
...
(deftest problem-137-test
     (testing "Problem 137: Write a function which returns a sequence of digits
of a non-negative number (first argument)
in numerical system with an arbitrary base (second argument).
Digits should be represented with their integer values,
e.g. 15 would be [1 5] in base 10,
...
(is (= [22 6 10 5 0 19 6 9 6 31] (__ js/Number.MAX_SAFE_INTEGER 42)))))