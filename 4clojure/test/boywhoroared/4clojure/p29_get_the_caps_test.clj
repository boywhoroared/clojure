(ns
  ^{:id 29 :difficulty "easy" :tags ["strings"] :description "Write a function which takes a string
...
(deftest problem-29-test
     (testing "Problem 29: Write a function which takes a string
