(ns
  ^{:id 150 :difficulty "medium" :tags ["seqs" "math"] :description "A palindromic number is a number that is the same when
...
(deftest problem-150-test
     (testing "Problem 150: A palindromic number is a number that is the same when
written forwards or backwards (e.g., 3, 99, 14341).
