(ns
  ^{:id 107 :difficulty "easy" :tags ["higher-order-functions" "math"] :description "Lexical scope and first-class functions
...
(deftest problem-107-test
     (testing "Problem 107: Lexical scope and first-class functions
are two of the most basic building blocks
of a functional language like Clojure.
When you combine the two together,
you get something very powerful called lexical closures.
