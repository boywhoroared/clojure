(ns
  ^{:id 27 :difficulty "easy" :tags ["seqs"] :description "Write a function which returns true
...
(deftest problem-27-test
     (testing "Problem 27: Write a function which returns true
if the given sequence is a palindrome.
