(ns
  ^{:id 161 :difficulty "elementary" :tags ["set-theory"] :description "Set A is a subset of set B, or equivalently B is a superset of A,
...
(deftest problem-161-test
     (testing "Problem 161: Set A is a subset of set B, or equivalently B is a superset of A,
